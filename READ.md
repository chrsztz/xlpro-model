...
<p align="center">
  🌍 <a href="[#deep-learning-based-piano-fingering-prediction-model](https://github.com/chrsztz/xlpro-model/blob/main/readme_en.md)">English Version</a> | 🎹 <a href="[#基于深度学习的钢琴指法预测模型开发](https://github.com/chrsztz/xlpro-model)">中文版本</a> 🌍
</p>
